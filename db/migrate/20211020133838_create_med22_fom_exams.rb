class CreateMed22FomExams < ActiveRecord::Migration[6.1]
  def change
    create_table :med22_fom_exams do |t|
      t.integer :user_id
    ...
    add_index :med22_fom_exams, [:user_id, :permission_group_id, :course_code], :unique => true, :name => 'by_med22_user_permission_group_course_code'
  end
end
