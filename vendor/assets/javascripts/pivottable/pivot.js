    ...
    try {
      ...
      _fn = function(c) {
        ...
        if (keys.length > opts.menuLimit) {
          ...
          btns.append($("<button type='button'>").html(opts.localeStrings.selectAll).bind("click", function() {
            return valueList.find("input").prop("checked", true);
          }));
          btns.append($("<button type='button'>").html(opts.localeStrings.selectNone).bind("click", function() {
        ...
        $("<p>").appendTo(valueList).append($("<button type='button'>").text("OK").bind("click", updateFilter));
