class Ability
  ...
  def initialize(user)
    ...
    logged_in_user_permissions(user)
    admin_user_permissions(user)
    other_user_permissions(user)
    deny_user_permissions(user)
  end

  def deny_user_permissions user
  ...
  ##
  # Permissions for all users (logged in only)
  def logged_in_user_permissions user
  ...
  def admin_user_permissions user
    return unless user.admin_or_higher?
    can :read, :all
  ...
  ##
  # Non Admin users
  def other_user_permissions user
    return unless user.admin_or_higher?
